...
public class Test {
    public static void main(String[] args) {
        ...
        //System.out.println(s1.getRadius()); getRadius нет в Shape, он в Circle
        ...
        //System.out.println(s4.getSide()); У Shape нет метода getSide(), он определяется у наследного класса
